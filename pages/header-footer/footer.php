<footer class="page-footer font-small bg-dark mt-5">
            ...
            <div class="row d-flex text-center justify-content-center mb-md-0 mb-4">
                <div class="col-md-8 col-12 mt-4">
                    <p class='text-white' style='line-height: 1.7rem'>Nos somos uma platafoma para você que precisa de ajuda nos estudo. Vêm com a gente.</p>
                </div>
            </div>
            </div>
    ...
    <script src="http://localhost/Ajuda-Estudantil/script/menu.js"></script>
    <script src="http://localhost/Ajuda-Estudantil/script/modal.js"></script>
    </body>
</html>